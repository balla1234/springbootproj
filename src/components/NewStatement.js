...
function NewStatement() {
    ...
    function fetchStatements() {
        ...
        // axios.get('http://localhost:8080/api/v1/auth/getTransaction', { headers: { 'Authorization': 'Bearer ' + info } })
            axios.get('http://3.16.188.155:30158/api/v1/auth/getTransaction', { headers: { 'Authorization': 'Bearer ' + info } })
            .then((res) => {
                const data = res.data;
    ...
    function handleClick() {
        ...
        if (stype === "between") {
            ...
            // axios.post('http://localhost:8080/api/v1/auth/byDateBetween', dts, { headers: { 'Authorization': 'Bearer ' + info } })
             axios.post('http://3.16.188.155:30158/api/v1/auth/byDateBetween', dts, { headers: { 'Authorization': 'Bearer ' + info } })
